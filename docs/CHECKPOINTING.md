...
A successful invocation deletes its checkpoint. Google ADK remains `checkpointing=false` until it has an equivalent runtime-neutral persistence/resume implementation.
